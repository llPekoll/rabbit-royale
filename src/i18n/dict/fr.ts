...
export const fr: Dict = {
  ...
  islandPick: {
    ...
    rowEmpty: (left, total, dug) => `personne dessus en ce moment \u00b7 ${left}/${total} coffres \u00b7 ${dug} % fouill\u00e9e`,
    ...
    youHave: (n) => `tu en as ${n}`,
    tier: (bombs, x) => `${bombs} % de bombes · un X juste +${x}`,
  },
  raid: {
    go: 'PARTIR PILLER',
