...
export const ptBR: Dict = {
  ...
  energyPanel: {
    ...
    tickRaid: 'saque',
    island: 'UMA ILHA',
    islandCost: (cross) => `${cross} na travessia, depois 1 por escava\u00e7\u00e3o`,
    raid: 'UM SAQUE',
    raidCost: (toll, stake) => `${toll} para entrar, ${stake} no m\u00e1ximo. Chegue ao campo: seus passos voltam.`,
    dig: 'ESCAVAR',
    digCost: (bomb) => `1 por escava\u00e7\u00e3o, uma bomba ${bomb}. Um X certo devolve, um errado custa 15.`,
    home: 'VOLTAR',
    homeCost: (floor) => `O que sobra fica no tanque. Acima de ${floor}, voc\u00ea chega com um saque.`,
    homeYes: 'D\u00c1 PARA SAQUEAR',
    homeNo: 'SEM SAQUE',
    level: (level, regen, next) => `Toca n\u00edvel ${level}: +${regen}/h \u00b7 n\u00edvel ${level + 1}: +${next}/h`,
    levelMax: (level, regen) => `Toca n\u00edvel ${level}: +${regen}/h`,
  },
  islandPick: {
    ...
    fresh: 'Ningu\u00e9m nela ainda \u00b7 a corrida longa',
    shortSafe: 'curta e segura',
    join: 'Entrar',
    open: 'Abrir',
    locked: (need, have) => `Abre com ${need} cavadas \u00b7 voc\u00ea ${have}`,
    lockedAria: (name, have, need) => `${name}: ${have} de ${need} cenouras cavadas`,
    lockedShort: 'Fechada',
    tank: (energy, cost) => `\u26a1 ${energy} no tanque \u00b7 a travessia leva ${cost}`,
    almostDone: 'quase acabando',
    ground: (bombIn, goldIn) => `\ud83d\udca3 1 casa em ${bombIn} \u00b7 \ud83e\udd55 1 cenoura em ${goldIn} \u00e9 de ouro`,
