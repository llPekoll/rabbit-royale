...
export const zh: Dict = {
  ...
  loop: {
    ...
    raidNeeds: (floor, have, wait) => `\u63a0\u593a\u9700\u8981 ${floor} \u70b9\u80fd\u91cf\u3002\u73b0\u5728 ${have}\uff0c${wait} \u540e\u591f\u3002`,
    raidIn: (wait) => `${wait}\u540e\u53ef\u63a0\u593a`,
    aMoment: '片刻',
    gardenPlus: (n) => `菜园 +${n}`,
    gardenEmpty: '菜园空了',
  ...
  run: {
    ...
    energyRaidLeft: '能量还够一次掠夺。现在回家，或继续挖。',
    homeRaid: '\u56de\u5bb6\u53bb\u63a0\u593a',
    crossed: (cost, energy) => `\u26a1 \u6e21\u6d77 -${cost} \u00b7 \u5269 ${energy}`,
  ...
  recap: {
    ...
    bank: (energy, max, cost) => `⚡ 储能 ${energy}/${max} · 渡海花 ${cost}`,
    raidLeft: (energy) => `⚡ 剩 ${energy}：够一次掠夺`,
    getEnergy: '补充体力',
    goHome: '回兔窝 · 囤起来',
    shoved: '被推下水！',
    struck: '被雷劈了！',
    shovedNote: (name) => `${name} 把你推下了水。`,
    struckNote: (name) => `${name} 把雷劈到了你头上。`,
    shovedNoteAnon: '有人把你推下了水。',
    struckNoteAnon: '有人把雷劈到了你头上。',
  },
  shove: {
    by: (name) => `${name} 推了你！`,
    anon: '有人推了你！',
  ...
  energyPanel: {
    open: '\u80fd\u91cf\u8be6\u60c5',
    title: '\u80fd\u91cf',
    perHour: (regen) => `\u6bcf\u5c0f\u65f6 +${regen}`,
    full: '\u5df2\u6ee1',
    fullIn: (wait) => `${wait}\u540e\u56de\u6ee1`,
    yes: '\u53ef\u4ee5',
    inWait: (wait) => `${wait}\u540e`,
    tickIsland: '\u51fa\u5c9b',
    tickRaid: '\u63a0\u593a',
    island: '\u51fa\u5c9b',
    islandCost: (cross) => `\u6e21\u6d77 ${cross}\uff0c\u4e4b\u540e\u6bcf\u6316\u4e00\u6b21 1`,
    raid: '\u63a0\u593a',
    raidCost: (toll, stake) => `\u8fdb\u95e8 ${toll}\uff0c\u6700\u591a ${stake}\u3002\u5230\u8fbe\u83dc\u5730\uff0c\u6b65\u6570\u9000\u8fd8\u3002`,
    dig: '\u6316\u6398',
    digCost: (bomb) => `\u6bcf\u6316\u4e00\u6b21 1\uff0c\u70b8\u5f39 ${bomb}\u3002\u6807\u5bf9\u8fd4\u8fd8\uff0c\u6807\u9519\u6263 15\u3002`,
    home: '\u56de\u5bb6',
    homeCost: (floor) => `\u5269\u4e0b\u7684\u7559\u5728\u50a8\u80fd\u91cc\u3002\u9ad8\u4e8e ${floor}\uff0c\u56de\u5bb6\u5c31\u80fd\u63a0\u593a\u3002`,
    homeYes: '\u591f\u63a0\u593a',
    homeNo: '\u4e0d\u591f\u63a0\u593a',
    level: (level, regen, next) => `\u5154\u7a9d ${level} \u7ea7\uff1a+${regen}/\u65f6 \u00b7 ${level + 1} \u7ea7\uff1a+${next}/\u65f6`,
    levelMax: (level, regen) => `\u5154\u7a9d ${level} \u7ea7\uff1a+${regen}/\u65f6`,
  },
  islandPick: {
    choose: '\u9009\u62e9\u5c9b\u5c7f',
    which: '\u53bb\u54ea\u5ea7\u5c9b\uff1f',
    ...
    join: '\u52a0\u5165',
    open: '\u5f00\u5c9b',
    locked: (need, have) => `\u6316\u6ee1 ${need} \u540e\u5f00\u653e \u00b7 \u4f60 ${have}`,
    lockedAria: (name, have, need) => `${name}\uff1a\u5df2\u6316 ${have}/${need} \u6839\u80e1\u841d\u535c`,
    lockedShort: '\u672a\u5f00\u653e',
    tank: (energy, cost) => `\u26a1 \u50a8\u80fd ${energy} \u00b7 \u6e21\u6d77\u82b1 ${cost}`,
    almostDone: '\u5feb\u6316\u5b8c\u4e86',
    ground: (bombIn, goldIn) => `\ud83d\udca3 ${bombIn} \u683c\u4e2d 1 \u683c\u662f\u70b8\u5f39 \u00b7 \ud83e\udd55 ${goldIn} \u6839\u4e2d 1 \u6839\u662f\u91d1\u841d\u535c`,
    best: (n) => `\u4f60\u7684\u7eaa\u5f55 ${n} \ud83e\udd55`,
    gone: '\u90a3\u5ea7\u5c9b\u6ee1\u4e86\u6216\u5df2\u7ed3\u675f\uff0c\u6362\u4e00\u5ea7\u5427\u3002',
    tierLocked: '\u4f60\u8fd8\u6ca1\u6316\u5230\u90a3\u5ea7\u5c9b\u3002',
  },
  ...
  lore: {
    'the-island': {
      ...
      body: [
        ...
        + '一排排橙色的冠冕从潮水刚刚退去的沙子里顶出来。发现它的兔子做了合情合理的事。'
        + '他们开始挖。',
    ...
    'the-tide': {
      ...
      teaser: '海在记账。',
      body: [
        '一座岛浮在它所守着的东西上面。每一个箱子都是压舱物，'
        + '而海一直在它们底下等着。拿走最后一个，水就漫过你挖开的地面——'
        + '这件事没得商量，掀开的也盖不回去。一座岛只发生一次。'
        + '它一直给，给到一个箱子都不剩，然后不怎么隆重地沉下去，兔子们游走。',

        '老兔子们不把这当灾难。他们把它当成一笔结清的账。'
        + '有东西被从世界里取走了，数量惊人，取走它的兔子每一步都被告知了确切的真相，'
        + '而他们选择继续走。岛屿只是回到水里，另一座在别处浮起，'
        + '已经满是胡萝卜，已经温热。',
      ],
    },
  },
