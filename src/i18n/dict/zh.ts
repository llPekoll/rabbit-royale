...
export const zh: Dict = {
  ...
  energyPanel: {
    ...
    island: '\u51fa\u5c9b',
    islandCost: (cost) => `\u6e21\u6d77 ${cost}\uff0c\u4e4b\u540e\u6bcf\u6316\u4e00\u6b21 1`,
    raid: '\u63a0\u593a',
    raidCost: (toll, stake) => `\u8fdb\u95e8 ${toll}\uff0c\u6700\u591a ${stake}`,
    raidRefund: '\u5230\u8fbe\u83dc\u5730\uff0c\u6b65\u6570\u9000\u8fd8\u3002',
    dig: '\u6316\u6398',
    digCost: (dig, bomb) => `\u6bcf\u683c ${dig}\u3002\u70b8\u5f39\uff1a${bomb}`,
    x: '\u7ea2 X',
    xCost: (lo, hi, loss) => `\u6807\u5bf9\uff1a\u8fd4\u8fd8 +${lo} \u5230 +${hi}\u3002\u6807\u9519\uff1a-${loss}`,
    home: '\u56de\u5bb6',
    homeCost: (floor) => `\u5e26\u7740 ${floor} \u4ee5\u4e0a\u56de\u5bb6\uff0c\u5c31\u80fd\u63a0\u593a`,
    homeHint: '\u5e26\u56de\u5bb6\u7684\u80fd\u91cf\u7559\u5728\u50a8\u80fd\u91cc\u3002',
    ready: '\u53ef\u4ee5',
    raidReady: '\u53ef\u63a0\u593a',
    needs: (floor) => `\u9700\u8981 ${floor}`,
    inWait: (wait) => `${wait} \u540e`,
    under: (floor) => `\u4e0d\u8db3 ${floor}`,
    levelLabel: (level) => `${level} \u7ea7`,
  ...
  islandPick: {
    ...
    rowEmpty: (left, total, dug) => `\u73b0\u5728\u6ca1\u6709\u4eba \u00b7 \u5269 ${left}/${total} \u4e2a\u5b9d\u7bb1 \u00b7 \u5df2\u6316 ${dug}%`,
    fresh: '\u8fd8\u6ca1\u6709\u4eba',
    join: '\u52a0\u5165',
    open: '\u5f00\u5c9b',
    ...
    tierLocked: '\u4f60\u8fd8\u6ca1\u6316\u5230\u90a3\u5ea7\u5c9b\u3002',
    youHave: (n) => `你已挖 ${n}`,
    tier: (bombs, x) => `${bombs}% 炸弹 · 标对一个 X +${x}`,
  },
  raid: {
    go: '出发掠夺',
    another: '掠夺另一个兔窝',
    choose: '选一个兔窝',
    whose: '掠夺谁的兔窝？',
    cost: (toll, stake) => `掠夺进门花 ${toll} 能量，最多 ${stake}。`,
    allShielded: '所有兔窝都有护盾',
    nobody: '没人可抢',
    shielded: '有护盾',
    presence: {
