...
export const zh: Dict = {
  ...
  energyPanel: {
    open: '\u80fd\u91cf\u8be6\u60c5',
    title: '\u80fd\u91cf',
    status: (energy, max, regen) => `${energy}/${max} \u00b7 \u6bcf\u5c0f\u65f6 +${regen}`,
    full: '\u6ee1\u4e86\u3002\u4e0d\u82b1\u5c31\u4e0d\u4f1a\u518d\u6da8\u3002',
    fullIn: (wait) => `${wait} \u540e\u81ea\u5df1\u56de\u6ee1\u3002`,
    islandYes: (cost) => `\u51fa\u5c9b\uff1a\u53ef\u4ee5\u3002\u6e21\u6d77\u82b1 ${cost}\uff0c\u4e4b\u540e\u6bcf\u6316\u4e00\u6b21\u82b1 1\u3002`,
    islandNo: (floor) => `\u51fa\u5c9b\uff1a\u8fd8\u4e0d\u884c\u3002\u9700\u8981 ${floor} \u70b9\u3002`,
    raidYes: (toll, stake) => `\u63a0\u593a\uff1a\u53ef\u4ee5\u3002\u8fdb\u95e8 ${toll}\uff0c\u6700\u591a ${stake}\uff1b\u5230\u8fbe\u83dc\u5730\u9000\u8fd8\u6b65\u6570\u3002`,
    raidNo: (floor) => `\u63a0\u593a\uff1a\u8fd8\u4e0d\u884c\u3002\u9700\u8981 ${floor} \u70b9\u3002`,
    dig: (dig, bomb) => `\u6316\u4e00\u6b21\u82b1 ${dig}\uff0c\u70b8\u5f39 ${bomb}\u3002\u6807\u5bf9\u8fd8\u80fd\u91cf\uff0c\u6807\u9519\u6263 15\u3002`,
    homeRaid: (floor) => `\u4f60\u8fd8\u591f\u4e00\u6b21\u63a0\u593a\uff08${floor}\uff09\u3002\u5e26\u56de\u5bb6\u7684\u80fd\u91cf\u7559\u5728\u50a8\u80fd\u91cc\u3002`,
    homeNoRaid: (floor) => `\u4f4e\u4e8e ${floor}\uff1a\u4e0d\u591f\u63a0\u593a\u4e86\u3002\u5e26\u56de\u5bb6\u7684\u80fd\u91cf\u7559\u5728\u50a8\u80fd\u91cc\u3002`,
    level: (level, regen, next) => `\u5154\u7a9d ${level} \u7ea7\u6bcf\u5c0f\u65f6\u56de ${regen}\uff1b${level + 1} \u7ea7\u4f1a\u56de ${next}\u3002`,
    levelMax: (level, regen) => `\u5154\u7a9d ${level} \u7ea7\u6bcf\u5c0f\u65f6\u56de ${regen}\u3002`,
  },
  islandPick: {
    choose: '\u9009\u62e9\u5c9b\u5c7f',
    which: '\u53bb\u54ea\u5ea7\u5c9b\uff1f',
