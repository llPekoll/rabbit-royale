...
static var FLASH_DEFENDED_OFFSETS := PackedFloat32Array([0.0, 18.0 / 68.0, 42.0 / 68.0, 1.0])
## Le halo rouge derriere les lettres.
static var HALO_DANGER := PackedColorArray([
